...
var UserService = /** @class */ (function () {
    function UserService() {
        ...
        this.singleIndex = function (id) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.userRepository.findOne(id, { relations: ['markets'] })];
                    case 1:
                        user = _a.sent();
        ...
        this.delete = function (id) { return __awaiter(_this, void 0, void 0, function () {
            var deletedUser, activeDelete;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.userRepository.findOne(id)];
                    case 1:
                        deletedUser = _a.sent();
                        if (!deletedUser) return [3 /*break*/, 3];
                        return [4 /*yield*/, this.userRepository.remove(deletedUser)];
                    case 2:
