...
var MarketController = /** @class */ (function () {
    function MarketController() {
        ...
        this.index = function (req, res) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.marketService.index()];
                    case 1:
                        markets = _a.sent();
        ...
        this.singleIndex = function (req, res) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        id = req['params']['id'];
                        return [4 /*yield*/, this.marketService.singleIndex(Number(id))];
                    case 1:
                        market = _a.sent();
                        res.json(market);
                        return [2 /*return*/];
        ...
        this.create = function (req, res) { return __awaiter(_this, void 0, void 0, function () {
            var market, userID, newMarket;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        market = req['body']['newMarket'];
                        userID = req['body']['userId'];
                        return [4 /*yield*/, this.marketService.create(market, userID)];
                    case 1:
                        newMarket = _a.sent();
                        res.send(newMarket);
                        return [2 /*return*/];
    ...
    MarketController.prototype.routes = function () {
